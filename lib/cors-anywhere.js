...
function getHandler(options, proxy) {
  var corsAnywhere = {
    ...
    originAllowlist: [`https://feremiyjeenyus.github.io/mtgo-results-scraper/`],            // If non-empty, requests not from an origin in this list will be blocked.
  ...
  return function(req, res) {
    ...
    if (corsAnywhere.originDenylist.indexOf(origin) >= 0) {
      ...
      res.end('The origin "' + origin + '" was Denylisted by the operator of this proxy.');
      return;
    }
